...
const ReferralTiersPage = () => {
  ...
  return <><PageHeader title="Referral Tiers" description="Configure reward thresholds in ascending referral order." icon="solar:cup-star-outline" actions={<button className="btn btn-primary-600" onClick={() => open()}>Add tier</button>} />
