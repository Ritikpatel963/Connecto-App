...
const ManualRechargePage = () => {
  ...
  return <><PageHeader title="Manual Recharge Approvals" description="Verify uploaded payment screenshots before crediting wallets." icon="solar:wallet-money-outline" />
