...
const AdminsPage = () => {
  ...
  return <><PageHeader title="Admins" description="Manage staff accounts and role assignments." icon="solar:user-shield-outline" actions={<button className="btn btn-primary-600" onClick={() => open()}>Add admin</button>} />
