...
const SETTING_KEY = "payout_coin_rate";

const PayoutPackagesPage = () => {
  ...
  const exampleCoins = 500;
  const examplePayout = (exampleCoins * rateNum).toFixed(2);

  return (
    <div className="payout-packages-page">
      <PageHeader
        title="Girls Payout Settings"
        description="Set the coins-to-rupees conversion rate for girl payout requests. This only affects payout calculations — not user recharge."
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <div className="input-group">
                      <span className="input-group-text bg-neutral-50 fw-semibold">
                        ₹
                      </span>
                      <input
                        type="number"
                    ...
                    <div className="form-text text-secondary-light mt-2">
                      How many coins make up 1 Rupee for payout conversions.
                    </div>
                  </div>
                  ...
                  {rateNum > 0 && (
                    <div className="alert alert-primary d-flex align-items-center gap-3 mb-4 border-0 bg-primary-50 text-primary-600 rounded-3">
                      ...
                      <div>
                        <strong>{exampleCoins} coins</strong> = <strong>Rs {(exampleCoins / rateNum).toFixed(2)}</strong>
                        <div className="text-sm opacity-75">Example payout at this rate</div>
                      </div>
                    </div>
                  )}
            ...
            <div className="card-body p-24">
              <ul className="list-unstyled d-flex flex-column gap-4 mb-0">
                <li className="d-flex gap-3">
                  ...
                  <div>
                    <div className="fw-semibold text-neutral-800">Girl earns coins</div>
                    <div className="text-secondary-light text-sm mt-1">From calls, gifts, or other platform activity.</div>
                  </div>
                </li>
                <li className="d-flex gap-3">
                  ...
                  <div>
                    <div className="fw-semibold text-neutral-800">She requests a payout</div>
                    <div className="text-secondary-light text-sm mt-1">The rupee amount is calculated using this rate.</div>
                  </div>
                </li>
                <li className="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-secondary-light text-sm mt-1">
                      <code className="bg-neutral-50 px-2 py-1 rounded text-primary-600 border">payout (Rs) = coins ÷ rate</code><br />
                      <div className="mt-2">Completely independent of user recharge packages.</div>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <div className="alert alert-warning mb-0 d-flex align-items-start gap-2 border-0 bg-warning-50 text-warning-600 rounded-3">
                ...
                <div className="text-sm">
                  Changing this rate only affects <strong>new payout requests</strong>. Already-approved withdrawals are not recalculated.
                </div>
              </div>
            </div>
          </div>
...
export default PayoutPackagesPage;
