...
export const walletTransactionsApi = {
  ...base,
  approve: (id: string | number) => resourceAction<WalletTransaction>("wallet-transactions", id, "approve", {}, { verification_status: "verified", reviewed_at: new Date().toISOString() }),
