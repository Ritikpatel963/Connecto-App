  ...
  const handleComplete = async () => {
    ...
    try {
      const payload = {
        ...
        state,
        country,
        profile_image_url: profileImageBase64 || `https://ui-avatars.com/api/?name=${encodeURIComponent(name || 'User')}&background=random`,
        is_online: true,
      ...
      if (newUserId) {
        setCurrentUser({
          ...
          name,
          age: parseInt(age),
          avatar: profileImageBase64 || `https://ui-avatars.com/api/?name=${encodeURIComponent(name || 'User')}&background=random`,
          role: role || 'boy',
